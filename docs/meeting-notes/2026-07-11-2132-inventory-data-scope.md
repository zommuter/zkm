...
- **Scope fence (all D):** out of scope for zkm-inventory — floor plans / 3D / BIM (d35e's broader umbrella beyond the device roster), live smarthome state, any write-back to drives, and Layer-2 `find`-dump drive-content file-search (separate deferred gate).
