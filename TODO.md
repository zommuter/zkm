...
- [ ] **[embed] Resume + complete the schema-4 embed rebuild.** **UNBLOCKED 2026-05-29** — [95b9]+[de33]+[a600]+[8497]+[d1f2] all shipped (zkm v0.10.0 + zkm-eml v0.12.0). Kill PID 95944 (`zkm status`), run `zkm scrub zkm-eml`, then `zkm index` clean. Riku gate: zero oversized/split lines in first ~500 chunks. <!-- id:402c -->
