...
- [ ] [INPUT — meeting] [INBOUND routed:1328 from zomni] HDD/external-drive asset inventory — searchable catalog (zkm search -> which drive); design manifest format (per-drive entity vs find-dump) in own /meeting <!-- id:f22d -->
