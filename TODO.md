...
- [ ] **PGP1.** Add `zkm.canonical.fingerprint(s)` + `fingerprint` entity type + join-grade note in `docs/entity-model.md`. Files: `src/zkm/canonical.py`, `tests/test_canonical.py`, `docs/entity-model.md`. See `docs/meeting-notes/2026-06-04-1002-pgp-keys-signature-validity.md`. <!-- id:734f -->
- [ ] **PGP2.** zkm-eml Tier A+B: detect `multipart/signed` leaf, CAS-preserve (no inbox fan-out), parse auth headers → `signed:` + `auth_results:` frontmatter. Fixture: PGP/MIME .eml w/ Authentication-Results. Version bump. See `docs/meeting-notes/2026-06-04-1002-pgp-keys-signature-validity.md`. <!-- id:4649 -->
...
- [ ] **PGP4 (design-note).** Forward-flag eml inline `application/pgp-keys` + `Autocrypt:` as Phase-4 2nd fingerprint producer in `docs/entity-model.md`. See `docs/meeting-notes/2026-06-04-1002-pgp-keys-signature-validity.md`. <!-- id:d54f -->
