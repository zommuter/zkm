...
- [ ] **Correct stale discovery:** `discoveries.md` entry "[2026-05-12 zkm] BM25 ignores entities[]" is STALE since E8 (commit `e56dd55`). Append correction via `append.sh -t discoveries`. See `docs/meeting-notes/2026-05-29-1443-7c-probe-synthetic-corpus.md`. <!-- id:0c63 -->
