...
- [ ] **[embed] Resume + complete the schema-3 embed rebuild (gated on [15b2]).** **RUNNING** as of 2026-05-28 (PID 95944, `zkm index`). ETA ~35h from start (88999 chunks). After completion: `zkm doctor` embed docs == md count. Decision (2026-05-21): feature-first single clean pass; see `docs/meeting-notes/2026-05-21-1908-embed-rebuild-eta-decision.md`. <!-- id:402c -->
