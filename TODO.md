...
- [ ] **`zkm init` missing `.zkm-state/` in default `.gitignore`** — `store.py` skeleton omits this dir; discovered when 27507 cache files were accidentally tracked in ~/knowledge. Fix: add `.zkm-state/` to the gitignore written by `zkm init`.
