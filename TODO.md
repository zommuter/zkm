...
- [x] **E9.** P2 field-test pilot — step 7 written to `docs/field-test-bge-m3.md`; probes: participant address search (7b), typed-value IBAN/amount queries (7c), P2-on vs P2-off index size (7d). User runs against real store to fill in findings — 2026-05-12.
